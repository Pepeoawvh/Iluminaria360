...
const PLANS = [
  {
    ...
    notIncluded: ["Fotografía arquitectónica plana", "Desarrollo de sitio web", "Video Inmobiliario"],
  ...
  },
  {
    ...
    notIncluded: ["Desarrollo de sitio web desde cero", "Video Inmobiliario"],
