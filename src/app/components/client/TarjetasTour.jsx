...
const TarjetasTour = () => {
  return (
    <>
      <h2
        className={`${abel.className} mt-4 pb-4 text-center font-bold text-2xl text-black`}
      >
        Beneficios para su negocio
      </h2>
      <div
        className={`${abel.className} grid auto-rows-min w-screen justify-items-center sm:grid-cols-3 sm:grid-rows-2 gap-4 sm:w-fit sm:p-8  -solid text-black`}
      >
        ...
        <div className="grid w-[90%] shadow-md p-4 rounded-xl  backdrop-blur-sm h-60 bg-slate-50 bg-opacity-30 group hover:scale-105 transition-transform duration-300">
          ...
          <div className="grid  inset-0 rounded-xl bg-white/70 opacity-0 group-hover:opacity-100 transition-opacity duration-500 backdrop-blur-sm">
            <div className="text-center  text-black px-12">
              ...
              <span className="grid mt-4 self-center text-sm">
        ...
        <div className="grid w-[90%] shadow-md p-4 rounded-xl  backdrop-blur-sm h-60 bg-slate-50 bg-opacity-30 group hover:scale-105 transition-transform duration-300">
          ...
          <div className="grid  inset-0 rounded-xl bg-white/70 opacity-0 group-hover:opacity-100 transition-opacity duration-500 backdrop-blur-sm">
            <div className="text-center  text-black px-12">
              ...
              <span className="grid mt-4 self-center">
