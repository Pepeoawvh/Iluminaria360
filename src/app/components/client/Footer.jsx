...
export default function Footer() {
  ...
  <footer className=" bg-neutral-200 text-center text-white border-t dark:bg-white bg-opacity-30 backdrop-blur-sm">
      <div className=" grid justify-items-center grid-cols-2 w-screen py-4">
        <Link href="https://www.instagram.com/joseangel.vh/" className="text-neutral-800  justify-self-center dark:text-zinc-800">
          <svg
        ...
        <Link href="https://www.linkedin.com/in/jos%C3%A9-%C3%A1ngel-vald%C3%A9s-hernandez-757124149/ "className="mr-9 text-neutral-800 dark:text-zinc-800">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-4 w-4"
            fill="currentColor"
